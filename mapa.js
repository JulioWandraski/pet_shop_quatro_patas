...
const unidades = [
    {
        id: "Matriz",
        nome: "Pet Shop Quatro Patas",
        lat: -24.978045, // Latitude - ALTERE para sua localização real
        lng: -53.413864, // Longitude - ALTERE para sua localização real
        endereco: "Rua Alterio Sordi, 832<br>Cascavel Velho - Cascavel/PR",
        telefone: "+55453222-0000",
        horario: "Seg-Sex: 8h-18h | Plantão nos demais dias e horários",
    ...
    },
    {
        ...
        lat: -24.955579,
        lng: -53.45569,
        endereco: "Av. do Brasil, 6518<br>Centro - Cascavel/PR",
        telefone: "+554599911-4321",
        horario: "Seg-Sex: 9h-19h | Plantão nos demais dias e horários",
        descricao: "Unidade moderna com estacionamento amplo.",
    },
...
class MapaInterativo {
    constructor() {
        ...
        this.btnMinhaLocalizacao = document.getElementById(
            "btnMinhaLocalizacao"
        );
    ...
    init() {
        ...
        if (typeof L === "undefined") {
            console.error(
                "Leaflet não foi carregado. Verifique a conexão com a internet."
            );
            return;
        }
        ...
        this.mapa = L.map("mapa").setView(
            [primeiraUnidade.lat, primeiraUnidade.lng],
            13
        );
    ...
    calcularRota() {
        if (!this.minhaLocalizacao) {
            alert(
                'Primeiro ative sua localização clicando em "Minha Localização"'
            );
            return;
        }
    ...
    centralizarUnidade(unidade) {
        ...
        const marcadorInfo = this.marcadores.find(
            (m) => m.unidade === unidade.id
        );
        if (marcadorInfo) {
        ...
        this.mapaElement.scrollIntoView({
            behavior: "smooth",
            block: "center",
        });
    }
        ...
        if (this.minhaLocalizacao) {
            ...
            distanciaText =
                distancia < 1
                    ...
                    : `<p><strong>Distância:</strong> ${distancia.toFixed(
                          1
                      )}km</p>`;
        }
